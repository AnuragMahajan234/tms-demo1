					...
					function() {
						...
						$('#example')
								.delegate(
										...
										function(e) {
											...
											var text = "Are you sure you want to delete Visa \""
													+ aData[1] + "\" ?";
											var successMessage = "Visa \""
													+ aData[1]
													+ "\" has been successfully deleted.";
											if (id == undefined || id == null
													|| id == '') {
												text = "Are you sure you want to delete this row ?";
												successMessage = "Visa has been successfully deleted.";
											}
						...
						function saveRow(oTable, nRow) {
							...
							/* if(spclCharacterValidation(stringName)){
								showError("Please Enter valid visa ");
								 stopProgress();
								return false;
				...
				<table class="dataTbl display tablesorter addNewRow alignCenter"
					...
					<thead>
						<tr>
							...
							<th width="8%" align="center" valign="middle">Visa</th>
							<th width="5%" align="center" valign="middle">Edit</th>
							<th width="5%" align="center" valign="middle">Delete</th>
						</tr>
					</thead>
					<tbody>
						<c:forEach var="visa" varStatus="visaStat" items="${visas}">
							<tr id="${visa.id}">
								<td align="center" valign="middle"><c:if
										test="${not empty visa.id}">${visaStat.index+1}</c:if></td>
								<td align="center" valign="middle"><c:if
										test="${empty visa.visa}">N.A.</c:if> <c:if
										test="${not empty visa.visa}">${visa.visa}</c:if></td>
