...
$('.removePo').on("click", function(){	
		...
		$('ul.tabs a[href="#tab1"]').click(function () {
			...
			$('a#ProjectActivityTabInactive').text("Project Activity");
...
function businessUnitValidate(businessUnit){
	...
	function optionGenerateHTML(obj) {
		...
		$.each(obj,function(ind,elm){
 			optionsHTML += '<option value="'+elm.id+'">'+elm.activityName+'</option>';
 		});
		return optionsHTML;
	}
	...
	function openMaintainance(id,projectName){
			...
			displayMaintainance(projectName);
			  ...
			  $.getJSON("projectactivitys/sepgActivity/" + id, function(data){
	...
	if (lst.selectedIndex<lst.options.length-1){
		...
		{ 
			...
			$('#listMenu1 option').each(function(i){ 
				projectActivitySEPGJson.push( $(this).attr('value') );
				});
		
			$('#listMenu2 option').each(function(i){ 
				custmActivityJson.push( $(this).attr('value') );
				});
			...
			if(projectActivity==0 && projectActivitySEPGJson==0 && custmActivityJson==0){
				showError("Please Select atleast one Project Activity");
		}else{
		 $.ajax({
			        url: 'projectactivitys/saveProjctActivity',
			      	contentType: "application/json",
			      	type:"GET",
			     	data: "projectActivityList=" + projectActivity +"&projectActivitySEPGJson="+ projectActivitySEPGJson + "&projectId=" + projectId +"&customActivity="+custmActivityJson,
			     	success: function(succeResponse) { 
			     		showSuccess(" Project Activities has been saved successfully ");
			     		$("#tab1").show();
			     		$("#tab2").hide();
			 	    ...
			 	    {
			 	    	showError("Project Activities cannot be  updated.");
			 	    }
			 });  
	...
	<div class="tab_seaction">
		<ul class='tabs'>
			...
			<li><a class="ProjectActivityTab MaintenanceTab"
				id="ProjectActivityTabInactive" href='#tab2'>Project Activity </a></li>
		</ul>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="0">
				<tr>
					<td><form name="form1" method="post" action="">
														...
														<table border="0" align="left" cellpadding="2"
															...
															<tr align="center" valign="middle">
																<td align="left" valign="top"
																	class="ent_elevenred defaultActivityHeading">Default
																	Activity</td>
										...
										<table width="100%" border="0" cellpadding="2" cellspacing="1"
											...
											<tr>
												<td width="58%" valign="top"><table border="0"
														align="left" cellpadding="2" cellspacing="1"
														class="borderlightgray">
														<th align="left">Map Custom</th>
														<tr align="center" valign="middle">
															<td align="left" valign="top"
																class="ent_elevenred defaultActivityHeading">Custom
																Activity</td>
															<td align="left" valign="top" class="text">&nbsp;</td>
															<td align="left" valign="top"
																class="ent_elevenred defaultActivityHeading">Custom
														...
														<tr align="center" valign="middle">
															<td valign="top" class="text"><span
																id="selectionView"> <select name=pdo2 size="7"
							...
							<br> <a href="#"
								data-href="projectactivitys/customActivities"
								id="customActivity" class="various"> Add Custom Activity</a> <br>
							<br>
...
<div class="notification-bar">
	...
	<sec:authorize
		...
		<div class="notification-text">Click on "Project Id" to add/map
			activities for your projects.</div>
	...
	<sec:authorize access="hasAnyRole('ROLE_ADMIN' )">
		<div class="notification-text">Click on "Project Id" to add/map
			activities for any projects.</div>
