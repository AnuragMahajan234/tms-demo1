<%-- <%@page import="com.yash.rms.util.Constants"%> --%>
						...
						$('#example')
								.delegate(
										...
										function(e) {
											...
											var url = "projectcategorys/" + id;
											var aData = oTable.fnGetData(nRow);
											var text = "Are you sure you want to delete Project Category \""
													+ aData[1] + "\" ?";
											var successMessage = "Project Category \""
													+ aData[1]
													+ "\" has been successfully deleted.";
											if (id == undefined || id == null
													|| id == '') {
												text = "Are you sure you want to delete this row ?";
												successMessage = "Project Category has been successfully deleted.";
											}
		...
		<div id='tab1' class="tab_div">
			...
			<div class="tbl">
				<table class="dataTbl display tablesorter addNewRow alignCenter"
					...
					<tbody>
						<c:forEach var="projectCategory" varStatus="projectCat"
							items="${projectcategorys}">
							<tr id="${projectCategory.id}">
								<td align="center" valign="middle"><c:if
										test="${not empty projectCategory.id}">${projectCat.index+1}</c:if>
								</td>
								<td align="center" valign="middle"><c:if
										test="${empty projectCategory.category}">N.A.</c:if> <c:if
										test="${not empty projectCategory.category}">${projectCategory.category}</c:if>
								</td>
