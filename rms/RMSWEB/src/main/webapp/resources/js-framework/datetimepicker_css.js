...
var WeekHeadColor = "#0066CC"; //var WeekHeadColor="#18861B";//Background Color in Week header.
...
var WeekDayColor = "#E8E8E8 "; //Background color of weekdays.
...
var SelDateColor = "#72A1C9"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
...
var imageFilesPath = "/rms/resources/images/";
...
function RenderCssCal(bNewCal)
{
	...
	if (Cal.ShowTime === true)
	{
		...
		vCalTime += "<td width='22px'><input type='text' name='hour' maxlength=2 size=1 style=\"WIDTH:30px;height:16px;\" value=" + showHour + " onkeyup=\"javascript:Cal.SetHour(this.value)\">";
		vCalTime += "</td><td style='font-weight:bold;text-align:center;'>:</td><td width='22px'>";
		vCalTime += "<input type='text' name='minute' maxlength=2 size=1 style=\"WIDTH: 30px;height:16px;\" value=" + Cal.Minutes + " onkeyup=\"javascript:Cal.SetMinute(this.value)\">";

		if (Cal.ShowSeconds)
		{
		    vCalTime += "</td><td style='font-weight:bold;'>:</td><td width='22px'>";
			vCalTime += "<input type='text' name='second' maxlength=2 size=1 style=\"WIDTH: 30px;height:16px;\" value=" + Cal.Seconds + " onkeyup=\"javascript:Cal.SetSecond(parseInt(this.value,10))\">";
		}
		...
		if (TimeMode === 12)
		{
			...
			vCalTime += "</td><td>";
			vCalTime += "<select name=\"ampm\" style=margin-left:3px; onChange=\"javascript:Cal.SetAmPm(this.options[this.selectedIndex].value);\">\n";
		...
		vCalTime += "<tr><td colspan='8' style=\"text-align:center;\"><input style='width:60px;font-size:12px;margin-top:3px;' onClick='javascript:closewin(\"" + Cal.Ctrl + "\");'  type=\"button\" value=\"OK\">&nbsp;<input style='width:60px;font-size:12px;margin-top:3px;' onClick='javascript: winCal.style.visibility = \"hidden\"' type=\"button\" value=\"Cancel\"></td></tr>";
	}
