...
function w_setDate(evt)
{
	...
	j = e_out;
		...
		document.getElementById(w_linkedInputText_1).value = '';
...
function buildWeeklyCalendar(WeekStart)
{
    ...
    document.write('<table class="calendar" cellspacing="2" cellpadding="0" border="0">');
    document.write('<tr><td colspan="8">');
    // header table
    document.write('<table width="100%" cellpading="0" cellspacing="0">');

    document.write('<tr class="firstrow"><td width="8px" onClick="w_renderCalendar(-1);" align="right" ><img src="resources/images/arrow_left.gif" title="' + prev_month_title + '" border="0"></td>');
    document.write('<td width="8px" onClick="w_renderCalendar(1);" align="left" ><img src="resources/images/arrow_right.gif" title="' + next_month_title + '" border="0"></td>');
    ...
    document.write('<td align="center" onClick="w_hiddenCalendar()"><img src="resources/images/close.jpg" title="' + close_title + '" border="0"></td>');
