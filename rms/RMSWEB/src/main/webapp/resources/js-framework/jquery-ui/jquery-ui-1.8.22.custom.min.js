        ...
        _generateHTML: function (a) {
            ...
            for (var L = 0; L < g[0]; L++) {
                ...
                for (var N = 0; N < g[1]; N++) {
                    ...
                    n++, n > 11 && (n = 0, o++), Q += '</tbody></table><div style="width:100%; height:20px;text-align:right"><input type="button" value="Clear Date" id="clearDate" /></div>' + (j ? "</div>" + (g[0] > 0 && N == g[1] - 1 ? '<div class="ui-datepicker-row-break"></div>' : "") : ""), M += Q
                }
                K += M
            }
...
/*function to add clear button on calendar*/
...
$('body').on("click",'#clearDate',function(){ 
	  $("#"+testid).datepicker("hide");
	  $("#"+testid).datepicker('setDate', null);
