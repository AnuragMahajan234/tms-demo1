/*! RMS app.js
 * ================
 * Main JS application file for RMS v2. This file
 * should be included in all pages. It controls some layout
 * options and implements exclusive RMS plugins.
 *
 * @Author  YASH Technologies
 * @Support <http://www.yash.com/>
 * @Email   <support@yash.com>
 * @version 2.3.0
 */
function _init() {
    "use strict";
    $.RMS.layout = {
        ...
        fix: function () {
            ...
            if ($("body").hasClass("fixed")) $(".content-wrapper, .right-side").css("min-height", b - $(".main-footer").outerHeight());
                ...
                var e = $($.RMS.options.controlSidebarOptions.selector);
                "undefined" != typeof e && e.height() > d && $(".content-wrapper, .right-side").css("min-height", e.height())
            }
        },
        fixSidebar: function () {
            return $("body").hasClass("fixed") ? ("undefined" == typeof $.fn.slimScroll && window.console && window.console.error("Error: the fixed layout requires the slimscroll plugin!"), void($.RMS.options.sidebarSlimScroll && "undefined" != typeof $.fn.slimScroll && ($(".sidebar").slimScroll({
                destroy: !0
        ...
        activate: function (a) {
            ...
            }), ($.RMS.options.sidebarExpandOnHover || $("body").hasClass("fixed") && $("body").hasClass("sidebar-mini")) && this.expandOnHover()
        },
        expandOnHover: function () {
            var a = this,
                b = $.RMS.options.screenSizes.sm - 1;
        ...
        var b = this,
            c = $.RMS.options.animationSpeed;
        $(document).on("click", function (e) {
            var p = $(e.target).parents(".treeview"),
                q = p.children().eq(1);
            if (!q.is(".treeview-menu") && !q.is(".treeview-menu-child")) {
                $(".treeview-menu").removeClass("menu-open");
                $(".treeview-menu").parent("li").removeClass("active");
            }
            if (!$(e.target).parents(".user-menu").children().eq(1).is("#mySidenav")) {
        ...
        $(document).on("click", a + " li a", function (a) {
            ...
            if (e.is(".treeview-menu") && e.is(":visible")) // e.slideUp(c, function() {
                ...
                $(".treeview-menu-child").removeClass("menu-open").css("display", "none"),
                ...
                //})
            } else if (e.is(".treeview-menu-child") && e.is(":visible")) {
        ...
        activate: function () {
            var a = this,
                b = $.RMS.options.controlSidebarOptions,
                c = $(b.selector),
        ...
        selectors: $.RMS.options.boxWidgetOptions.boxWidgetSelectors,
        icons: $.RMS.options.boxWidgetOptions.boxWidgetIcons,
        animationSpeed: $.RMS.options.animationSpeed,
        activate: function (a) {
            var b = this;
...
if ("undefined" == typeof jQuery) throw new Error("RMS requires jQuery");
$.RMS = {},
    $.RMS.options = {
        ...
        "use strict";
        $("body").removeClass("hold-transition"), "undefined" != typeof RMSOptions && $.extend(!0, $.RMS.options, RMSOptions);
        var a = $.RMS.options;
        _init(), $.RMS.layout.activate(), $.RMS.tree(".sidebar"), a.enableControlSidebar && $.RMS.controlSidebar.activate(), a.navbarMenuSlimscroll && "undefined" != typeof $.fn.slimscroll && $(".navbar .menu").slimscroll({
            height: a.navbarMenuHeight,
            alwaysVisible: !1,
            size: a.navbarMenuSlimscrollWidth
        }).css("width", "100%"), a.sidebarPushMenu && $.RMS.pushMenu.activate(a.sidebarToggleSelector), a.enableBSToppltip && $("body").tooltip({
            selector: a.BSTooltipSelector
        }), a.enableBoxWidget && $.RMS.boxWidget.activate(), a.enableFastclick && "undefined" != typeof FastClick && FastClick.attach(document.body), a.directChat.enable && $(document).on("click", a.directChat.contactToggleSelector, function () {
