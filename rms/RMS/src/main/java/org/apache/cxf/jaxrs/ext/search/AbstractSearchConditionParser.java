...
public abstract class AbstractSearchConditionParser<T> implements SearchConditionParser<T> {
    ...
    protected Object parseType(String originalPropName, 
        ...
        if (index == -1) {
           ...
           /* System.out.println(" castedValue before converting parseType @AbstractSearch"+castedValue);
    ...
    /**
     * Commented CXF Generic code because it was not supporting Date with Time so make it enable we used another format
     * **/
