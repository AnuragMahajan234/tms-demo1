...
public class RMReport {
	...
	public static String toJsonArray(Collection<RMReport> collection) {
		...
		return new JSONSerializer()
				.include("yashEmpID", "employeeName", "emailId", "designation",
						...
						"allocationEndDate","resumeYN","tefYN","deliveryManager")
				.exclude("*")
				.transform(new DateTransformer(Constants.DATE_PATTERN_4),
						Date.class).serialize(collection);
	}

	public static String toJson(RMReport rmReport) {
		...
		return new JSONSerializer()
				.include("yashEmpID", "employeeName", "emailId", "designation",
						...
						"primarySkill", "secondarySkill", "customerId",
						"lastUpdateBy", "lastupdateTimeStamp",
						"allocationEndDate","resumeYN","tefYN","projectManager", "totalExp", "relExp", "yashExp", "allocatedSince","deliveryManager")
				.exclude("*")
				.transform(new DateTransformer(Constants.DATE_PATTERN_4),
						Date.class).serialize(rmReport);
	}
