...
public interface IGenericDao<Pk, Entity> extends IBaseDao<Pk, Entity>{
	 ...
	 */
	 List<Entity> search(SearchContext ctx ,Integer maxLimit,Integer minLimit ) throws DaoRestException;
	 ...
	 * @throws DaoRestException 
	 */
	 List<Entity> search(SearchContext ctx ,Integer maxLimit,Integer minLimit,String orderby,String orderType ) throws DaoRestException;
