...
public class ResourceOnBenchSearchCriteria {
	...
	public ResourceOnBenchSearchCriteria() {
		...
		cols = new String[]{ "resume", "employeeId", "yashEmpId", "employeeName", "designationName", "allocationType" };
