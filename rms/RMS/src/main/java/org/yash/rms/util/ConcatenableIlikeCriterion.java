...
public class ConcatenableIlikeCriterion implements Criterion {
	 ...
	 */
	public ConcatenableIlikeCriterion(String value, MatchMode match,
			String... columns) {
	...
	public TypedValue[] getTypedValues(Criteria criteria,
		...
		return new TypedValue[] { criteriaQuery.getTypedValue(criteria,
				columns[0], value.toString().toLowerCase()) };
	...
	public String toSqlString(Criteria criteria, CriteriaQuery criteriaQuery)
		...
		for (int i = 0; i < columns.length; i++) {
			realColumns[i] = criteriaQuery.getColumnsUsingProjection(criteria,
					columns[i])[0];
		}
	...
	public static ConcatenableIlikeCriterion ilike(String value,
			MatchMode match, String... columns) {
