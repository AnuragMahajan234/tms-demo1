...
<tr>
	<td style="padding-left:10px; padding-top: 10px; padding-right:10px; padding-bottom:10px;background-color:#FEEFB3; color:#9F6000; border:1px solid #9F6000; font-weight:bold;">	
		...
		Please access RMS application and refer Loan/Transfer history section.
		<br />
	</td>
</tr>
</table>
...
<#list hrInfromation?keys as key> 
...
<#assign first=hrInfromation[key][0]>
<#assign second=hrInfromation[key][1]>
<#if first ==second>
<td>
${hrInfromation[key][1]}
</td>
