...
) ENGINE=InnoDB AUTO_INCREMENT=42817 DEFAULT CHARSET=latin1;
...
CREATE TABLE `mails_configuration` (
  ...
  `mail_bcc` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15968 DEFAULT CHARSET=latin1;
...
CREATE TABLE `request_requisition` (
  ...
  `shift_type_id` int(11) DEFAULT '2' COMMENT 'FK from shift types.',
...
) ENGINE=InnoDB AUTO_INCREMENT=6009 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=15776 DEFAULT CHARSET=latin1;
...
CREATE TABLE `skill_request_resource` (
  ...
  `creation_timestamp` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `lastupdated_timestamp` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=21057 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=82758 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=380543 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=227064 DEFAULT CHARSET=latin1;
